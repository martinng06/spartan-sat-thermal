...
- `q_sun_W_per_m2` / `q_albedo_W_per_m2` — absorbed heat flux (W/m²), i.e. already multiplied by surface absorptivity

## Profile shape

Each file is a step-function approximation of a low-Earth-orbit (~400 km, ISS-like) thermal environment:

- **Sunlit arc (~60 min):** flux is at its peak value
...
These step-function loads feed the Thermal Desktop / ANSYS transient model.
See `docs/01-mission-and-environment.md` for the full environment definition.
